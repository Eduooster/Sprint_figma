...
public class Main {
    public static void main(String[] args) {
        ...
        var exercicio2 = new ExericicioMultiplaEscolha("Qual é a tradução de 'Thank you'?",
        ...
        for(Exercicio exercicio : licao1.getExercicios()){
            ...
            if(exercicio instanceof ExericicioMultiplaEscolha) {
                var exercicioME = (ExericicioMultiplaEscolha) exercicio;
                int i = 1;
